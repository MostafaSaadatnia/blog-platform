...
@Component({
    ...
    .empty { opacity: .7; font-size: .9rem; padding: 8px; text-align: center; }
  `],
    template: `
    <div class="wrap">
      @if (canPost) {
        <div class="editor">
          <form [formGroup]="form" (ngSubmit)="submit()">
            <mat-form-field appearance="outline" class="w-full" style="width:100%;">
              ...
              <textarea matInput rows="3" formControlName="body" placeholder="Share your thoughts…"></textarea>
            ...
            <div class="row">
              ...
              <button mat-flat-button color="primary" type="submit" [disabled]="form.invalid || store.posting()">Post</button>
            </div>
          </form>
        </div>
      }
      ...
      @if (store.loading()) {
        <div class="item"><mat-progress-spinner diameter="24" mode="indeterminate"></mat-progress-spinner></div>
      } @else {
        <div class="list">
